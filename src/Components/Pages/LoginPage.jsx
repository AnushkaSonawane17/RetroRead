...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#F6EFE3] flex items-center justify-center px-4 py-10">
      ...
      >
        {/* LEFT — photo panel */}
        <div className="hidden md:flex relative min-h-[600px] flex-col justify-between p-8 overflow-hidden">
          <img
          ...
          <div className="relative flex items-center gap-2 text-[#F6EFE3]">
        ...
        {/* RIGHT — form */}
        <div className="bg-[#FFFBF3] p-8 md:p-12 flex flex-col justify-center">
          <div className="mb-8">
            <h2 className="font-display text-3xl font-bold text-[#1E2A42]">Welcome Back!</h2>
            <p className="text-[#8A7F6B] text-sm mt-1.5">Login to continue your reading journey.</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="field-wrap relative">
              <label className="block text-xs font-medium text-[#5B6478] mb-1.5">Email or Username</label>
              <div className="flex items-center gap-2.5 px-3.5 py-2.5 bg-[#F6EFE3] rounded-lg border border-[#E2D5BC]">
                <Mail size={15} className="text-[#8A7F6B] shrink-0" />
                <input
                  type="text"
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 text-[#5B6478] cursor-pointer select-none">
                <input
                  type="checkbox"
                  checked={remember}
                  onChange={(e) => setRemember(e.target.checked)}
                  className="h-4 w-4 rounded border-[#D9C7A3] text-[#D8472F] focus:ring-0 accent-[#D8472F]"
                />
                Remember me
              </label>
              <Link to="/forgot-password" className="text-[#D8472F] font-medium hover:underline">Forgot Password?</Link>
            </div>
